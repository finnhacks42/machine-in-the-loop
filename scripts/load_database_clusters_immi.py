...
def main(args):
    ...
    for (theme_id, theme_name) in themes:
        cur.execute('select text from phrase_immi where goodness = "good" and theme_id = {}'.format(theme_id))
        ...
        for line in lines:
            ...
            if name == "MentionsArgument":
                ...
                for pos in positions:
                    ...
                    query = 'UPDATE tweet_immi SET theme_id = {}, distance = {} where tweet_id = {}'
    ...
    for twid in id2pos:
        if twid not in mentions_argument:
            ...
            for pos in positions:
                query = 'UPDATE tweet_immi SET theme_id = {} where tweet_id = {}'
